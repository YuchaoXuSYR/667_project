...
class TreeAI():
    ...
    def getScore(self):
        ...
        stander=np.array([[1,1],[4,4],[4,4],[10,10],[400,100],[5000,2000],[10000,9000],[9999999,9999999]])
        self.type_count= self.type_count*stander

        scores = self.type_count.sum(axis=0)
    ...
    def __search(self, board, depth, alpha = SCORE_MIN, beta = SCORE_MAX):
        ...
        for x, y in moves:
            ...
            board[x][y][1] = 1
            score = - self.__search(board, depth - 1, -beta, -alpha)
            board[x][y][1] = 0
